...
const Auth = () => {
    ...
    const googleFailure = (error) => {
        console.log(error);
        console.log("Google Sign In was unscuessful. Try Again Later");
    };
    return (
        <Container component="main" maxWidth="xs">
            <Paper className={classes.paper} elevation={3}>
                ...
                <form className={classes.form} onSubmit={handleSubmit}>
                    ...
                    <GoogleLogin
                        clientId="931498084124-tdpueq3h2haojb8jfrjshtfv3frojnsl.apps.googleusercontent.com"
                        render={(renderProps) => (
                    ...
                    <Grid container justify="flex-end">
                        <Grid item>
                            <Button onClick={switchMode}>
                                {isSignup ? "Already have an account? Sign In" : "Don't have accout? Sign Up"}
                            </Button>
                        </Grid>
                    </Grid>
                </form>
